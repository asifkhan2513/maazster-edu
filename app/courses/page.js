...
const Courses = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section
        id="courses"
        className="py-10 bg-gradient-to-br from-blue-50 to-indigo-100 pt-24"
      >
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4 text-gray-800">OUR COURSES</h2>
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Explore our comprehensive range of industry-focused courses designed
            to accelerate your tech career with hands-on projects and expert
            mentorship
          </p>
